...
class Pot:
    def __init__(self, volume_pot: float, volume_water: float):
        ...
        Примеры:
        >>> pot = Pot(1000, 200)  # инициализация экземпляра класса
        """
...
class Telegram_chanel:
    def __init__(self, followers: int, max_followers: int):
        ...
        if not isinstance(max_followers, (int, float)):
        ...
        self.max_follower = max_followers
    ...
    def remove_people_from_telegram_channel(self, estimate_people: float) -> None:
        """
